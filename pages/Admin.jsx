  ...
  return (
    <Layout>
      <main className={styles.main}>
        ...
        <Section topic="Inmuebles" publicView={false} color='#c98f8f'></Section>
        <Section topic="Vehiculos" publicView={false} color='#8FC2C9'></Section>
        <Section topic="Empleos" publicView={false} color='#c98f8f'></Section>
        <Section topic="Servicios" publicView={false} color='#c98f8f'></Section>
        <Section topic="Electronica" publicView={false} color='#8FC2C9'></Section>
        <Section topic="Academico" publicView={false} color='#c98f8f'></Section>
        <Section topic="Varios" publicView={false} color='#8FC2C9'></Section>
